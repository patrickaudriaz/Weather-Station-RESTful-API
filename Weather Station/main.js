                ...
                if (line_chart_temp == null) {
                    line_chart_temp = new Chart(ctxTemp, {
                        ...
                        data: {
                            labels: [label],
                            datasets: [{
                                label: data.sensors.temperature.name + " in [" + data.sensors.temperature.unit + "]",
                ...
                if (line_chart_hum == null) {
                    line_chart_hum = new Chart(ctxHum, {
                        ...
                        data: {
                            labels: [label],
                            datasets: [{
                                label: data.sensors.humidity.name + " in [" + data.sensors.humidity.unit + "]",
                    ...
                    addDataToChart(line_chart_hum, label, data.sensors.humidity.current_condition.value);
                } else {
                    line_chart_hum = null;
                }
                ...
                if (line_chart_press == null) {
                    line_chart_press = new Chart(ctxPress, {
                        ...
                        data: {
                            labels: [label],
                            datasets: [{
                                label: data.sensors.pressure.name + " in [" + data.sensors.pressure.unit + "]",
                    ...
                    addDataToChart(line_chart_press, label, data.sensors.pressure.current_condition.value);
                } else {
